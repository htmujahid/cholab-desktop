...
class Info(tk.Frame):
    ...
    def create_info_tab(self):
        heading1 = tk.Label(self.parent, text='Atomic Number:',
                            font=('Arial', 11, 'bold'))
        ...
        heading2 = tk.Label(self.parent, text='Atomic Mass:',
                            font=('Arial', 11, 'bold'))
        ...
        heading3 = tk.Label(self.parent, text='Period:',
                            font=('Arial', 11, 'bold'))
        ...
        heading4 = tk.Label(self.parent, text='Group:',
                            font=('Arial', 11, 'bold'))
        ...
        heading6 = tk.Label(self.parent, text='Block:',
                            font=('Arial', 11, 'bold'))
        ...
        heading7 = tk.Label(self.parent, text='Description:',
                            font=('Arial', 11, 'bold'))
        ...
        heading8 = tk.Label(self.parent, text='Appearance:',
                            font=('Arial', 11, 'bold'))
        heading8.grid(row=7, column=0, sticky='w')
        label1 = tk.Label(
            self.parent, text='''The physical structure of an element''')
        label1.grid(row=7, column=1, sticky='w')
        heading9 = tk.Label(self.parent, text='Melting Point:',
                            font=('Arial', 11, 'bold'))
        ...
        heading11 = tk.Label(self.parent, text='Phase:',
                             font=('Arial', 11, 'bold'))
        heading11.grid(row=10, column=0, sticky='w')
        label1 = tk.Label(
            self.parent, text='''The physical structure of an element''')
        label1.grid(row=10, column=1, sticky='w')
        heading12 = tk.Label(self.parent, text='Structure:',
                             font=('Arial', 11, 'bold'))
        ...
        heading19 = tk.Label(self.parent, text='Isotope:',
                             font=('Arial', 11, 'bold'))
